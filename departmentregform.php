   ...
   require 'elearningmenu.php';
    ...
    <div class="container-fluid page-header" style="margin-bottom: 90px;">
        <div class="container">
            ...
            ?>
                <h3 class="display-4 text-white text-uppercase">department form</h3>
...
<form action="departmentadd.php" method="post" enctype="multipart/form-data">
    ...
    <option value="Human Relations">Human Relations</option>
		...
		<tr><th align="left">Description</th><th align="left"><textarea name="description" placeholder="a little about this department" required></textarea></th></tr>
		<tr><th align="left">Number of students</th><td><input type="number" name="nostud"></td></tr>
    ...
    <option value="5.0">5.0</option>
            ...
            <tr><th align="left">Type</th><td><input type="radio" name="type" value="Liscensce">Liscensce&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="B.sc.">B.sc.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="Masters">Masters</td></tr>
