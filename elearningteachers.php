                 ...
                 <div class="col-md-6 col-lg-3 text-center team mb-4">
                    <div class="team-item rounded overflow-hidden mb-2">
                        <div class="team-img position-relative">
                            <img class="img-fluid"><?php echo "<td><img src=imageteacher/$tecreg[5].jpg></td>"; ?>
                        ...
                        <div class="bg-secondary p-4">
                            <h5><?php echo "<td>".$tecreg['full_names']."</td>"; ?></h5>
                            <p class="m-0">Department: <?php echo "<td>".$tecreg['department']."</td>"; ?></p>
                        </div>
                    </div>
                </div>
<?php 
